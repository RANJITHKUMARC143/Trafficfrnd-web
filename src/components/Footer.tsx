          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@curiospry.com" className="text-gray-400 text-sm hover:text-orange-500 transition-colors duration-200">
              ...
              <div className="flex items-start space-x-3">
                <svg className="h-4 w-4 text-orange-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
