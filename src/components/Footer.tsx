...
const Footer = () => {
  return (
    <footer className="text-white bg-gradient-to-b from-gray-900/80 via-gray-900/70 to-gray-900/80 supports-[backdrop-filter]:backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <img src="/images/logo1.png" alt="Traffic Frnd" className="h-6 w-auto object-contain" />
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Delivering convenience to your vehicle during traffic. Making every red signal a shopping opportunity.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/curio_spry_official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors duration-200">
              ...
              <a href="https://www.linkedin.com/in/curiospry-technologies-327987354/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors duration-200">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/@CURIOSPRYTECHNOLOGIES" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors duration-200">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@curiospry.com" className="text-gray-400 text-sm hover:text-emerald-500 transition-colors duration-200">
                  contact@curiospry.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="h-4 w-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start space-x-3">
                <svg className="h-4 w-4 text-emerald-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
